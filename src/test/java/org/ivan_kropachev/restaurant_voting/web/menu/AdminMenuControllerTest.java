...
public class AdminMenuControllerTest extends AbstractControllerTest {
    ...
    void getByDate() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "by-date?date=" + DATE)
    ...
    void createWithLocation() throws Exception {
        Menu newMenu = getNew();
        ResultActions action = perform(MockMvcRequestBuilders.post(REST_URL + "restaurant/" + RESTAURANT1_ID)
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(REST_URL + "restaurant/" + RESTAURANT1_ID + "/date/?date=2021-12-03")
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(admin))
